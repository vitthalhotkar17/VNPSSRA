        ...
        <div className="wi-bob">
          <svg className="wi-fig" viewBox="0 -12 140 272" xmlns="http://www.w3.org/2000/svg">
            ...
            <g className="wi-leg-left">
              ...
              <rect x="48" y="204" width="18" height="6" rx="2" fill="#211d54" />
              <path d="M46,208 h24 a4,4 0 0 1 4,4 v3 a3,3 0 0 1 -3,3 h-27 a3,3 0 0 1 -2,-5 z" fill="url(#wiShoe)" />
              <rect x="50" y="212" width="18" height="1.6" fill="#453f78" opacity="0.6" />
            </g>
            ...
            <g className="wi-arm-right">
              ...
              <circle cx="101.5" cy="132" r="7.2" fill="url(#wiSkinShade)" />
            </g>

            {/* speech bubble */}
            <g className="wi-bubble" transform="translate(92 18)">
              <rect x="0" y="0" width="34" height="26" rx="12" fill="rgba(255,255,255,0.95)" />
              <path d="M24 26 L30 36 L30 26 Z" fill="rgba(255,255,255,0.95)" />
              <text x="17" y="18" textAnchor="middle" fill="#312e81" fontSize="13" fontWeight="700">Hi!</text>
            </g>
          </svg>
        </div>
      </div>

      <p className="wi-caption">Welcome Mark your attendance…</p>
    </div>
  );
}
